...
import { WorldMapImageSrc } from './WorldMapSvgSource';
...
const PdfDocument = () => {
  // const imgSrc = WorldMapImageSrc();
  // console.log('imgSrc', imgSrc);

  // const worldMap = ReactDOMServer.renderToStaticMarkup(<WorldMap />);
  // const buffer = worldMap.replace(
  //   '<svg ',
  //   '<svg xmlns="http://www.w3.org/2000/svg" '
  // );
  const svgString = encodeSvg(<SVGComponent />);
  //console.log(svgString);
  //const wordMapBuffer = new Buffer(svgString);
    ...
    <Document>
      <Page size="A4" style={styles.page}>
        ...
        <View style={styles.section}>
          ...
          {/* <Image src={imgSrc} /> */}
          {/* <WorldMap /> */}
          {/*https://github.com/diegomura/react-pdf/issues/734*/}
          {/* <Image src={`data:image/jpeg;base64,${data}`} style={styles.image} /> */}
          {/* <Canvas
            paint={(painter) =>
              painter
                .moveTo(100, 150)
